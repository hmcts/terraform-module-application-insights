...
| <a name="input_sampling_percentage"></a> [sampling\_percentage](#input\_sampling\_percentage) | Specifies the percentage of telemetry data to sample. Defaults to 100% for production and 1% for all other environments. | `number` | `null` | no |
